...
export default function About() {
  return (
    <div className='mx-auto max-w-7xl p-3 space-y-4 text-lg'>
        ...
        <p>Please note that SEEDA is not a commercial product, but a demo built to test my knowledge in React and Next.js, as well as how to fetch and handle APIs. While the app uses real-time data from The Movie Database (TMDb), its primary aim is to demonstrate my skills in these areas.</p>

        <p>I appreciate you taking the time to explore this project, and I hope you find it informative as you browse through the features of the SEEDA Movie Discovery app!</p>
